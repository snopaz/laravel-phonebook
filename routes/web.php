...
Route::get('/entreprise/create', 'EntreprisesController@create')->middleware('auth', 'admin', 'gestionnaire');
...
Route::get('/entreprise/update/{id}', 'EntreprisesController@edit')->middleware('auth', 'admin', 'gestionnaire');
...
Route::get('/collaborateur/create', 'CollaborateursController@create')->middleware('auth', 'admin', 'gestionnaire');
...
Route::get('/collaborateur/update/{id}', 'CollaborateursController@edit')->middleware('auth', 'admin', 'gestionnaire');
Route::put('/collaborateur/{id?}', 'CollaborateursController@update')->middleware('auth');
